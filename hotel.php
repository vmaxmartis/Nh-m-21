  ...
  <div class="container">
    ...
    <div class="col-md-12 col-lg-9 mx-auto p-4 p-sm-5">
      <div class="text-center px-0 px-sm-5">
        <p class="mb-3 lead">Hơn 1008 Khách sạn có thể bạn quan tâm . . . </p>
                ...
                <div class="TravelGo-category-content fl-wrap title-sin_item " >
                  <div class="TravelGo-category-content-title fl-wrap">
                    <div class="TravelGo-category-content-title-item">
                      ...
                      <div class="TravelGo-category-location fl-wrap"><a href="#" class="map-item"><i class="fas fa-map-marker-alt"></i> <?php echo $row_pro['address'] ?></a> 
                      <br><br>   <h3 class="text-warning"><?php echo $row_pro['pricemin'] ?>đ      -      </h3>  <h3 class="text-warning"><?php echo $row_pro['pricemax'] ?>đ </h3> 
