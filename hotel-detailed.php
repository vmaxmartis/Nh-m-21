    ...
    <div class="row">
          ...
          <div class="col-18">
            ...
            <div class="col-md-12">
                <div id="leaveReview" class="mt-4 collapse show" style="">
                  ...
                  <form id="contact-form" method="get" action="xulycmt_hotel.php" class="form">
                    <div class="row cmtct">
      ...
      <div class="col-lg-4 col-md-12 col-sm-12 right_Details">
        <div class="p-4 shadow ml-lg-4 rounded sticky-top" style="top: 100px;">
          ...
          <hr class="my-4">
          <div class ="chinout">
          <a href="#" class="btn btn-outline-success">Checkin <br> <?php echo $row_ct['checkin'] ?> </a><a href="#" class="btn btn-outline-white">-</a><a href="#" class="btn btn-outline-danger">checkout <br> <?php echo $row_ct['checkout'] ?> </a>  
          </div>
          <hr class="my-4">
              <!-- Listing Location-->
      ...
      <div class="swiper-container guides-slider-popular"> 
        ...
        <div class="swiper-wrapper"> 
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 swiper-slide">
            <div class="listroBox">
              <figure> <a href="hotel-detailed.html" class="wishlist_bt"></a><a href='hotel-detailed.php?chon=<?php echo $row_pro['id'] ?>'><img src="bdesign/images/img_source/<?php echo $row_pro['iva1'] ?>" class="img-fluid" alt="" >
                <div class="read_more"><span>Xem thêm</span></div>
                </a> </figure>
              <div class="listroBoxmain">
                <h3><a href="hotel-detailed.html"><?php echo $row_pro['title'] ?> <p class="R_retings"><?php echo $row_pro['rank'] ?> Sao</p>
                <p><?php echo $row_pro['address'] ?> </p>
                <a class="address" href="#"><?php echo $row_pro['shortcontent'] ?></a> </div>
              <ul>
                <li>
