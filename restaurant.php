    ...
    <div class="text-center px-0 px-sm-5">
        ...
        <form  action="./search-restaurant.php">
          <div class="input-group px-0 px-md-5">
            <input class="form-control border-radius-right-0 border-right-0 bg-transparent" name="search-restaurant" type="search" id="search-restaurant" placeholder="Tên khách sạn mà bạn muốn tìm kiếm ...">
                ...
                <div class="TravelGo-category-content fl-wrap title-sin_item " >
                  <div class="TravelGo-category-content-title fl-wrap">
                    <div class="TravelGo-category-content-title-item">
                      ...
                      <div class="TravelGo-category-location fl-wrap"><a href="#" class="map-item"><i class="fas fa-map-marker-alt"></i> <?php echo $row_pro['address'] ?></a>  </div>
                    </div>
                  </div>
                  <p><?php echo $row_pro['shortcontent'] ?></p>
