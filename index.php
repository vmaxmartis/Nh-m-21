  ...
  <div class="container">
    <div class=" blockquote grad-line">
				...
				<div class="mt-3 mt-md-0 text-md-right ml-md-auto align-self-center">
					<button href='hotel.php' class="btn btn-primary mb-0">Xem thêm!</button>
				</div>
			</div>
    <div class="row">
...
<!-- Modal default start-->
  ...
  <a class="btn btn-primary" href="#"><i class="fas fa-arrow-circle-right"></i>Tất cả nhà hàng</a>
...
<!-- Modal default end-->
    ...
    ?>
      ...
      ?>
          <div class="col-lg-4 col-md-6 col-sm-12 swiper-slide">
            <div class="listroBox">
              <figure> <a href="restaurant-detailed.html" class="wishlist_bt"></a><a href='restaurant-detailed.php?chon=<?php echo $row_pro['id'] ?>'><img width="100%" height="351" src="bdesign/images/img_source/<?php echo $row_pro['iva1'] ?>" class="img-fluid" alt="" >
                <div class="read_more"><span>Xem thêm</span></div>
                </a> </figure>
              <div class="listroBoxmain">
                <h3><a href="restaurant-detailed.html"><?php echo $row_pro['title'] ?> 
                <p><?php echo $row_pro['address'] ?> </p>
                <a class="address" href="#"><?php echo $row_pro['shortcontent'] ?></a> </div>
              <ul>
                <li>
