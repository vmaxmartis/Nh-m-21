...
if(isset($_POST['title'])){
    ...
    $sql="INSERT INTO travel(id,city,regions,title,address,author,content,scontent,like,map,yt) VALUES 
    (null,'$city','$regions','$title','$address','$author','$content','$scontent','$like','$map','$yt')";

    $query=mysqli_query($conn,$sql);
    if($query){
        header('location:http://localhost/v1/Nhom21/Nhom21/admin1/index.php');
    }else{
        echo"Đang lỗi !!!";
    }
