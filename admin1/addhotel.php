...
<?php
    if(isset($_POST['add'])){
        ...
        $rate = $_POST['rate'];
        $map = $_POST['map'];
        if($conn -> query("INSERT INTO `hotel` VALUES ('','$city','$rank','$title','$iva1','$iva2','$iva3','$iva4','$iva5','$shortcontent','$content','$checkin','$checkout','$pricemax','$pricemin','$address','$nborate','$rate','$map')")){
                            ...
                            <div class="ibox-body" style="">
                                <form method="POST" action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 form-group">
                                            <label>Rank</label>
                                            <input class="form-control" type="text" placeholder="regions" name="rank">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                            <label>Tiêu đề</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="14h00" name="checkin">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                            <label>Check-out</label>
                                            <input class="form-control" type="text" placeholder="23h00" name="checkout">
                                        </div>
                                        <div class="col-sm-3 form-group">
                                    ...
                                    <button name="add" class="btn btn-outline-success">Lưu vào</button>
                                    </div>
                                </form>
                            </div>
                        </div>
